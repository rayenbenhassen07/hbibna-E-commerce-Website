...
<body>
    ...
    <div class="register_page">
            ...
            <p class="register_slog">Tous les paramètre dans cette page est obligatoire</p>
            
            <form action="functions/authcode.php" method="POST">
                <div class='information a1'>
                    <h3>Information personnelle</h3>
                    <div for="nom" class='labell'>Prenom<span> *</span></div>
                    <input type="text" name="nom" required>

                    <br>

                    <div for="nom" class='labell'>Nom <span> *</span></div>
                    <input type="text" name="prenom" required>

                </div>
                <div class='information a2'>
                    <h3>Information de compte</h3>
                    <div for="email" class='labell'>Email<span> *</span></div>
                    <input type="email" name="email" required>

                    <br>

                    <div for="password" class='labell'> Mot de passe<span> *</span></div>
                    <input type="password" name="mdp" required>

                    <div for="password1" class='labell'>Confermer Mot de passe<span> *</span></div>
                    ...
                    <div class="error_information"><?php echo $_SESSION['message']; ?></div>
                    ...
                    <div class="buttom_formule">
                        <button type="submit" name="creer_compte" id="submit" class="submit">Créer un Compte</button>
                    </div>
