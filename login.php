...
<body>
    ...
    <div class="register_page">
            ...
            <p class="register_slog">Si vous n'aviez pas de compte vous deviez créer un compte</p>
            
            <form action="functions/authcode.php" method="POST">
                <div class='information a1'>
                    <h3>Clients enregistrés</h3>

                    <p class="login_slog">Si vous avez un compte, connectez-vous avec votre adresse e-mail.</p>
                    ...
                    <div class="buttom_formule">
                        <button type="submit" name="login_compte" id="submit" class="submit">Se Connecter</button>
                    </div>
                ...
                <div class='information a2'>
                    ...
                    <div class="buttom_formule">
                        <a href="register.php"><div class="creer_compt">Créer un Compte</div></a>
                    </div>
