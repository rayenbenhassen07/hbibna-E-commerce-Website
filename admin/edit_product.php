                    ...
                    <form action="connection.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="f1">
                            ...
                            <select name="category">';
                                ...
                                while ($roww = mysqli_fetch_array($select_cat)) {
                                    $selected = ($row['category_id'] == $roww['id']) ? 'selected' : '';
                                    echo '
                        ...
                        <div class="f4">
                            ...
                            <textarea rows="3" required name="small_description"  placeholder="enter small description" >'.$row['small_description'].'</textarea>
                        ...
                        <div class="f56">
                            <div class="f5">
                                ...
                                <input type="text" required name="original_price" value="'.$row['original_price'].'" placeholder="enter original price" >
                            </div>

                            <div class="f6">
                                <label name="">Selling Price</label><br>
                                <input type="text" required name="selling_price" value="'.$row['selling_price'].'" placeholder="enter selling price" >
                            </div>
                        </div>
                        ...
                        <div class="f7910">
                            <div class="f8">
                                ...
                                <input type="number" required name="quantity" value="'.$row['qty'].'" placeholder="enter quantity" >
                            </div>
                            <div class="f910">
                                <div class="f9">
                                ...
                                <div class="f10">
                                    ...
                                    <input type="checkbox"  '. ($row['trending'] == '0' ? '' : 'checked') .' name="populas">
                                    <input type="hidden" name="product_id"  value="'.$_GET['id'].'" alt="img1">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="f11">
                            ...
                            <textarea rows="3" required  name="meta_Description" placeholder="enter Meta Description" >'.$row['meta_discription'].'</textarea>
                        </div>
                        ...
                        <div class="validation">
                            <button type="submit" class="valider-btn" name="update-product">Save</button>
                        </div>
