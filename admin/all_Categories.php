...
<body>
    <section class="welcome_page">
        ...
        <div class="header">
            <div class="title">See categories</div>
            <div class="product_display">
                <table class="product_display_table">
                    ...
                    <?php
                        $select = mysqli_query($con,"SELECT * FROM categoes");
                        while ($row = mysqli_fetch_array($select)) {
                            ...
                            <tr>
                                ...
                                <td class="edit_td">
                                    <a href=edit_categories.php?id='.$row['id'].'><button name="edit_Cat" class="edit_btn">edit</button></a><br>
                                    <form method="POST" action="connection.php">

                                        <input type="hidden" name="categories_id" value='.$row['id'].'>
                                        <a href=edit_product.php><button name="delete_Cat" class="delete_btn">delete</button></a>
